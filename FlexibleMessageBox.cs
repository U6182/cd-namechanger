    ...
    */
    public class FlexibleMessageBox
    {
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private static readonly String[] BUTTON_TEXTS_JAPANISE_JA = { "OK", "Cancel", "&はい", "&いいえ", "&Abort", "&Retry", "&Ignore" };
            #endregion
            ...
            private TwoLetterISOLanguageID languageID = TwoLetterISOLanguageID.ja;
            ...
            private string GetButtonText(ButtonID buttonID)
            {
                ...
                switch (this.languageID)
                {
                    ...
                    case TwoLetterISOLanguageID.ja: return BUTTON_TEXTS_JAPANISE_JA[buttonTextArrayIndex];
